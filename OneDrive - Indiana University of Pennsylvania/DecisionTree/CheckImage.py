...
class Net(nn.Module):
    def __init__(self):
        ...
        # We'll dynamically calculate the fc1 input size in forward()
        self.fc1 = nn.Linear(64 * 7 * 7, 128)  # For 28x28 MNIST images
    ...
    def forward(self, x):
        ...
        # Flatten the tensor - dynamically calculate based on current tensor shape
        x = x.view(batch_size, -1)

        # Dynamically handle the fc1 input if needed
